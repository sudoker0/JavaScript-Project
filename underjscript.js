...
var _ = underjscript = function() {
     ...
     * @param {OscillatorType} type - The type of the waveform (Accepted type: sine, square, sawooth, triangle)
     */
    ...
    func.isOnline = function() {
        ...
        xmlhttp.onload = function() { return true; }
        xmlhttp.onerror = function() { return false; }
